...
public class FindAndReplaceDOB {
	...
	public static void main(String[] args) {
		...
		iterable.forEach(new Block<Document>() {
			...
			public void apply(final Document document) {
				if (document.containsKey("dob")) {
					String existing = document.get("dob").toString();
					String newV = document.get("dob").toString() + "000";
					LOGGER.debug("Existing = " + existing + " new = " + newV);

					document.put("dob", newV);
